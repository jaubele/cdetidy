...
#' @param export_log_path File path to the export log CSV. Default is a shared T drive location.
...
#'
#' @return Invisibly returns `NULL`. Files are written to disk, and schema is logged to the SQL schema log.
#'
#' @export
