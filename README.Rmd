...
A tidyverse-style toolkit for working with California Department of Education
(CDE) datasets.

The `cdetidy` R package contains functions developed by the Orange County
Department of Education (OCDE) for transforming, validating, labeling, and
exporting public CDE datasets. It supports internal OCDE workflows related to
data warehousing, reporting, and dashboard preparation, but may also be useful
